 ...
 * Description:       This plugin changes the pagination of WooCommerce products to Roger's pagination. /n From page 1 it links only to page 2 (href and next). From page 2 it links to everything (except page 2). From page 3 onwards it links to page 1, previous and next. /n Also add teen
 * Version:           0.0.1
...
define('SEOIMPROVEMENTS_VERSION', '0.0.1');
